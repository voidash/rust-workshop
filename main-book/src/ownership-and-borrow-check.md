...
## [Read about Stack vs Heap ](./stack-vs-heap.md)

## Compile Time and Run Time
Compile time is when your code is being converted to executable format.
Runtime is when your executable is being run.
